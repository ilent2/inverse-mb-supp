function F = Mathieu(x,r,q, type)
  % Minimal collection of functions needed for generating regular
  % Mathieu beams.  This is copied from OTTv2 (and the previous version
  % from bscPmMathieu) but it will probably change a bit before the
  % final OTTv2 release.
  %
